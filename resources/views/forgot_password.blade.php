            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="card border-success" style="margin-top: 4%;max-width: 35rem;padding: 2%;">
                    ...
                    <div>
                        ...
                        <a href="{{ route('loginlogin') }}" class="float-end btn btn-outline-dark" style="margin-top: -9%;">Login</a>
                    </div>
                    <hr>
                    <div class="card-body">
                        <form action="{{ route('send_forgot_password_email') }}" method="POST" name="forgotPassForm" enctype="multipart/from-data">
                            @csrf
